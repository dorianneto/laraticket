...
@section('content')
    <div class="container">
        <div class="page-header">
            <h1>{{ trans('module.ticket.edit_title') }}</h1>
        </div>
        <ol class="breadcrumb">
            ...
            <li class="active">{{ trans('module.ticket.edit_title') }}</li>
        </ol>
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">{{ trans('module.ticket.edit_subtitle') }}</h3>
                    </div>
                    <form action="{{ route('ticket.update', $data->id) }}" method="post">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
